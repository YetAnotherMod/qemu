...
#define SPR_476_MMUBE0        (0x334)
#define SPR_476_MMUBE1        (0x335)
#define SPR_RMPD              (0x339)
#define SPR_ISPCR             (0x33d)
#define SPR_SSPCR             (0x33e)
#define SPR_USPCR             (0x33f)
#define SPR_UPMUCC0           (0x34a)
#define SPR_IC                (0x350)
#define SPR_VTB               (0x351)
#define SPR_DCESR             (0x352)
#define SPR_MMCRC             (0x353)
#define SPR_ICESR             (0x353)
#define SPR_PSSCR             (0x357)
#define SPR_PMUCC0            (0x35a)
#define SPR_IOCCR             (0x35c)
#define SPR_IOCR1             (0x35d)
#define SPR_IOCR2             (0x35e)
...
#define PPC_TCG_INSNS  (PPC_INSNS_BASE | PPC_POWER | PPC_POWER2 \
    ...
    /*   PowerPC 476 TLB management instructions                             */
    PPC2_476_TLB       = 0x0000000000200000ULL,
#define PPC_TCG_INSNS2 (PPC2_BOOKE206 | PPC2_VSX | PPC2_PRCNTL | PPC2_DBRX | \
                        ...
                        PPC2_ISA300 | PPC2_ISA310 | PPC2_476_TLB)
};
