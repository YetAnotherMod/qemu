...
static void gen_isync(DisasContext *ctx)
{
    ...
    gen_helper_476_shadow_tlb_flush(tcg_env);
...
static void gen_tlbre_476(DisasContext *ctx)
{
    ...
    case 2:
        {
            TCGv_i32 t0 = tcg_constant_i32(rB(ctx->opcode));
            gen_helper_476_tlbre(cpu_gpr[rD(ctx->opcode)], tcg_env,
                                 t0, cpu_gpr[rA(ctx->opcode)]);
        }
        break;
    default:
...
static void gen_tlbwe_476(DisasContext *ctx)
{
    ...
    case 2:
        {
            TCGv_i32 t0 = tcg_constant_i32(rB(ctx->opcode));
            gen_helper_476_tlbwe(tcg_env, t0, cpu_gpr[rA(ctx->opcode)],
                                 cpu_gpr[rS(ctx->opcode)]);
        }
        break;
    default:
...
static void gen_tlbsx_476(DisasContext *ctx)
{
    ...
    t0 = tcg_temp_new();
    gen_addr_reg_index(ctx, t0);
    gen_helper_476_tlbsx(cpu_gpr[rD(ctx->opcode)], tcg_env, t0);
    if (Rc(ctx->opcode)) {
        TCGLabel *l1 = gen_new_label();
        tcg_gen_trunc_tl_i32(cpu_crf[0], cpu_so);
        tcg_gen_brcondi_tl(TCG_COND_EQ, cpu_gpr[rD(ctx->opcode)], -1, l1);
...
GEN_HANDLER(dccci, 0x1F, 0x06, 0x0E, 0x00000001, PPC_4xx_COMMON),
...
GEN_HANDLER_E(rfci, 0x13, 0x13, 0x01, 0x03FF8001, PPC_NONE, PPC2_476_TLB),
...
GEN_HANDLER_E(dlmzb, 0x1F, 0x0E, 0x02, 0x00000000, PPC_NONE, PPC2_476_TLB),
GEN_HANDLER_E(mbar, 0x1F, 0x16, 0x1a, 0x001FF801,
              PPC_BOOKE, PPC2_BOOKE206),
GEN_HANDLER(msync_4xx, 0x1F, 0x16, 0x12, 0x039FF801, PPC_BOOKE),
GEN_HANDLER_E(msync_4xx, 0x1F, 0x16, 0x12, 0x039FF801, PPC_NONE, PPC2_476_TLB),
GEN_HANDLER2_E(icbt_440, "icbt", 0x1F, 0x16, 0x00, 0x03E00001,
               PPC_BOOKE, PPC2_BOOKE206),
GEN_HANDLER2(icbt_440, "icbt", 0x1F, 0x06, 0x08, 0x03E00001,
             PPC_440_SPEC),
GEN_HANDLER_E(icbt_440, 0x1F, 0x16, 0x00, 0x02000001,
