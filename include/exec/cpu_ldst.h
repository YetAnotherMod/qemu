...
uint32_t cpu_atomic_cmpxchgw_mmu(CPUArchState *env, abi_ptr addr,
                                    uint32_t cmpv, uint32_t newv,
                                    MemOpIdx oi, uintptr_t retaddr);
uint32_t cpu_atomic_cmpxchgl_mmu(CPUArchState *env, abi_ptr addr,
                                    uint32_t cmpv, uint32_t newv,
                                    MemOpIdx oi, uintptr_t retaddr);
uint64_t cpu_atomic_cmpxchgq_mmu(CPUArchState *env, abi_ptr addr,
...
Int128 cpu_atomic_cmpxchgo_mmu(CPUArchState *env, abi_ptr addr,
